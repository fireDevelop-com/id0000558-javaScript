    ...
    prodEl.innerHTML = `
        <div>
          ...
          <div class="product-item__content">
            <h2>${this.product.title}</h2> <h3>\$${this.product.price}</h3> <p>${this.product.description}</p>
...
class ProductList {
  products = [
    new Product('A Pillow', 'https://appiconmaker.co/Content/icon_temp.png', 'A soft pillow!', 19.99),
